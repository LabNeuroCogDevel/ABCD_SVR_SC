...
#subs="300 1000 1964"
#subs="1814"
subs="1000" ###abritrary number for this script but useed in saving 
...
#props=.9
echo "props $props"
export savedir="/home/bct16/data/PCA5_20200910_taskplusrest/"
...
export propvarretain=$pv
	...
	sbatch -o $logfile -e $logfile -J "$JOBID" compute_svr.taskplurest.sh
