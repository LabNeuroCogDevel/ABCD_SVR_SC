...
#subs="300 1000 1814"
subs="1814"
NJOBS=101  ###number of jobs in parallel
#COUNTER=0
...
#props=.9
#echo "props $props"
export savedir="/home/bct16/data/PCAdim_20200819nested10sensitivity/"
...
#abcd_tbss01_nihtbx_cryst_agecorrected"
...
export propvarretain=$pv
	...
	JOBID="abcd_${samplesize}_${iter}_${pv}"
	...
	sbatch -o $logfile -e $logfile -J "$JOBID" compute_svr.nested10.sh
