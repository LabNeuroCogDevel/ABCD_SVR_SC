...
#subs="1814"
subs="1930"
NJOBS=2  ###number of jobs in parallel
#COUNTER=0
#ys="abcd_cbcls01_cbcl_scr_syn_totprob_t abcd_tbss01_nihtbx_totalcomp_agecorrected"
#ys="Fscore_residualized Fscore"
ys="Fscore"
#props=".1 .2 .3 .4 .5 .6 .7 .8 .9 1"
#props=$(seq 0.1 0.1 1)
#props=.9
echo "props $props"
export savedir="/home/bct16/data/ABCD_CU/PCA5_20200827/"
...
export propvarretain=$pv
	...
	outfilename="${savedir}/PCA.${pv}.NOTUNE.$JOBID.${y}_perm.n${samplesize}.chunk1.rdata"	
	...
	sbatch -o $logfile -e $logfile -J "$JOBID" compute_svr.cu.sh
